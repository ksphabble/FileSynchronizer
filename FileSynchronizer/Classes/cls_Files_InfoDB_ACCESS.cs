...
namespace FileSynchronizer
{
    ...
    public static class cls_Files_InfoDB_ACCESS
    {
        ...
        private static void DB_Upgrade_V3011(int Current_DB_Ver)
        {
            ...
            {
                OleDbCommand cmd_dbupgradeV3011_b1 = new OleDbCommand(sql_dbupgradeV3011_b1, dbconn_ACCESS);
                cmd_dbupgradeV3011_b1.ExecuteNonQuery();

                OleDbCommand cmd_dbupgradeV3011_b2 = new OleDbCommand(sql_dbupgradeV3011_b2, dbconn_ACCESS);
        ...
        public static bool UpdatePairInfor(string str_PairID, string str_FilterRule, string str_SyncInterval, string str_SyncDirection, string str_AutoSyncFixedInterval, out string OutputMsg)
        {
            OutputMsg = String.Empty;
            cls_SQLBuilder _SQLBuilder = new cls_SQLBuilder(cls_SQLBuilder.DATABASE_TYPE.ACCESS);
            string sql_upd = _SQLBuilder.SQL_UpdatePairInfor(str_PairID, str_FilterRule, str_SyncInterval, str_AutoSyncFixedInterval, str_SyncDirection);
